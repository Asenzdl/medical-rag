...
# 全局默认配置
DEFAULT_ONNX_PATH = Path(__file__).parent / "onnx" / "chinese-roberta-wwm-ext-distilled-27745" / "none" / "model.onnx"
DEFAULT_OUTPUT_PATH = Path(__file__).parent / "onnx" / "chinese-roberta-wwm-ext-distilled-27745" / "none" / "model.trt"
